                        ...
                        <div class="col-lg-6">
                            <div class="p-5">
                                <div class="text-center">
                                    <h1 class="h4 text-gray-900 mb-4">{{ __('Pendaftaran Siswa Baru') }}</h1>
                                </div>
                                ...
                                <form method="POST" action="{{ route('register') }}" class="user">
                                    ...
                                    <div class="form-group">
                                        <input type="text" class="form-control form-control-user" name="last_name" placeholder="{{ __('Nama Terakhir') }}" value="{{ old('last_name') }}" required>
                                    </div>
